...
public class CYOAObject {
	...
	public String decisionChoice2() {
		// TODO Auto-generated method stub
		return name + ", You choose the life of a villian. Do you want to pursue villanous status or rethink your choice? 1(yesy), 2(no)";
	}
	public String finalchoice2() {
		// TODO Auto-generated method stub
		return name + ", After being brought to the guild you start to use your will powers for evil instead of good. You start to get jealous of every other apprentice and start siding with the enemy of evil and attack and consume the life of those you have dearly loved."
	...
	public String otherChoice2() {
		// TODO Auto-generated method stub
		return name + ", You rethink the villanous pursuit of the hero and maybe try another route";
	}
	public String decisionChoice3() {
		// TODO Auto-generated method stub
		return name + ", You choose the life of a anti hero. Do you embrace the nomad life or do you rethink your choices 1(yes), 2(no).";
	}
	public String finalChoice2() {
		// TODO Auto-generated method stub
		return name + ", When you are brought to the guild you start seeing the corruption in the guild, but you don’t see the good in siding with the pure evil doers."
	...
	public String otherChoice3() {
		// TODO Auto-generated method stub
		return name + ", You decide not to pursue the nomad life and decide to rethink the hero's fate";
	}
	public String decisionChoice4() {
		// TODO Auto-generated method stub
		return name + ", You choose the fate of the hero becoming the new Jack Of Blades or do you think the hero should have another fate? 1(yes), 2(no)";
	}
	public String finalchoice4() {
		// TODO Auto-generated method stub
		return name + ", After pursuing the life of good and then reaching the point to throw away the sword of Eons or to vanquish your sister. "
	...
	public String otherchoices4() {
		// TODO Auto-generated method stub
		return name + ", You decide the hero should not be the evil ruler of these pure lands";
	}
	public String ending() {
		// TODO Auto-generated method stub
		return name + ", You are fighting in the Arena as the hero you have gotten bored of the sitting life"
	...
	public String scene2choice1() {
		// TODO Auto-generated method stub
		return name + ", You choose to fight the ill fated Nostro. Nostro was once a hero of the guild and fell in battle against The Jack Of Blades. "
	...
	public String scene2choice2() {
		// TODO Auto-generated method stub
		return name + ", You choose to fight the dragon, a creature of extreme power and mythical abilities that even the mightiest will users fear the most."
	...
	public String scene2choice3() {
		// TODO Auto-generated method stub
		return name + ", You choose to fight the wraith, a ghost that forever haunts the graves of corrupted will users. "
	...
	public String scene2choice4() {
		// TODO Auto-generated method stub
		return name + ", You choose to fight the bandit King of the Bandit Clan. "
